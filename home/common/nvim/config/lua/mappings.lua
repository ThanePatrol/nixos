...
-- Trouble.lua start
vim.api.nvim_set_keymap('n', '<leader>xx', '<cmd>Trouble diagnostics toggle<cr>', {silent = true, noremap = true, desc = "Diagnostics (Trouble)"})
vim.api.nvim_set_keymap('n', '<leader>xX', '<cmd>Trouble diagnostics toggle filter.buf=0<cr>', {silent = true, noremap = true, desc = "Buffer Diagnostics (Trouble)"})
vim.api.nvim_set_keymap('n', '<leader>cs', '<cmd>Trouble symbols toggle focus=false<cr>', {silent = true, noremap = true, desc = "Symbols (Trouble)"})
